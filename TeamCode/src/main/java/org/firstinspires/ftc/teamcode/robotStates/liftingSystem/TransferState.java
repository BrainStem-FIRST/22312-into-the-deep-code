    ...
    public void execute() {
        if(robot.shouldTransfer()) {
            ...
            if (robot.getLift().getStateManager().getActiveStateType() == Lift.StateType.TROUGH_SAFETY) {
                // keeps repeating transfer until color sensor does not sense color
        ...
        else if(robot.getLift().getTransitionState().getGoalStatePosition() != Lift.TROUGH_SAFETY_POS) {
